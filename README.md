...
- **High precision** due to 64-bit floating points containing SI base units, and mostly CODATA 2022 constants.
...
6. **Conversions** such as *SI::to_string()* in [SI/conversions.h](SI/conversions.h)
7. **Datasets** such as *dataset::chemical_elements* in 📂[datasets](datasets/)
8. **Unit Tests** at compile-time in [SI/tests.h](SI/tests.h) and on each commit by [GitHub Actions](https://github.com/fleschutz/libSI/actions)
