...
Units library to apply math with physical units correct, precise, and ASAP. This lib provides:
...
- [x] **Convenient** literals (e.g. 24_h or 3_GWh), unit conversions, and import/export.
